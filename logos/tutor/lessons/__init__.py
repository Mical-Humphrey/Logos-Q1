...
def registry():
    ...
    from .mean_reversion import build_glossary as mr_gloss, generate_transcript as mr_transcript, generate_plots as mr_plots
    from .momentum import build_glossary as mom_gloss, generate_transcript as mom_transcript, generate_plots as mom_plots
    from .pairs_trading import build_glossary as pair_gloss, generate_transcript as pair_transcript, generate_plots as pair_plots
    return {
        "mean_reversion": {
...
def _new_lesson_run(lesson: str, base_dir: Path, when: datetime) -> LessonContext:
    ...
    return LessonContext(lesson, run_dir, logs_dir, transcript_file, glossary_file, plots_dir, logger, handler)
